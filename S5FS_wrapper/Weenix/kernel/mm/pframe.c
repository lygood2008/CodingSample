...
get_start:;
    ...
    pframe_t* page = pframe_get_resident(o, pagenum);
    ...
    if (page != NULL)
    {
        ...
        {
            *result = page;
            KASSERT(*result != NULL && !pframe_is_busy((*result)));
            dbg(DBG_S5FS, "}\n");
