/**
 * File: DropboxFileServerMasterNet.java
...
class DropboxFileServerMasterNet {
	...
	/* Two sockets for different type of data*/
	...
	/**
	 * DropboxFileServerMasterNet
	 * @param server: the file sever object
	 */
	...
	public void listen(){
		...
		_userNet = new DropboxFileServerUserNet(_server,
												_userOut,
												_userIn,
												_userSock);
		_userNet.start();
	...
	protected boolean connect(){
		...
		try{
			...
			_userIn = new BufferedReader(
					  new InputStreamReader(_userSock.getInputStream()));
	...
	/**
	 * closeConnections: close the connections. has retry mechanism
	 */
